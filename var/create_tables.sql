...
--
--  группа 'guest_multisession':
--          'guest_multisession': разрешает использовать одновременно несколько сессий (как и 'multisession'),
--              но в отличии от 'multisession' не предоставляет ряд возможностей
--              (например не предоставляется возможность закрыть все сессии)
--
--  группа 'ip_limit':
